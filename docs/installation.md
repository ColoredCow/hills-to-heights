...
Before starting, ensure you have a local web server with PHP PHP 8.3.21, MySQL 8.4, and Apache 2.4.65 (or Nginx 1.29.2); you don’t need to install everything manually — use one of the quick setup tools below based on your system.
